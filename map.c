...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/27 21:14:10 by saazcon-          #+#    #+#             */
/*   Updated: 2023/03/06 22:21:43 by saazcon-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long.h"

void	ft_paint(int last, char *map, struct s_data *d)
{
	if (map[last] == 'P')
	{
		d->path = 1;
...
void	ft_check_path(int i, struct s_data *d)
{
	char	*aux_map;
...
void	ft_check_min(struct s_data *d)
{
	int		i;
...
int	ft_check_edg(struct s_data *d)
{
	int	i;
	int	x;
	int	len;
...
void	ft_check_map(struct s_data *d)
{
	...
	if ((d->num_c * d->num_c) == ((len + 1) - d->num_l))
		ft_error(d);
	d->letter_c = 0;
	d->letter_p = 1;
	d->letter_e = 1;
